...
export default class SignUp extends React.Component {
  state = {
    ...
    pregnant: null,
    infant: null,
    /*babyGender:null,*/ liveMiami: null,
    babyDOB: null,
  };
  ...
  setUserInfo = (keyToValue) => {
    if (
      this.isEquivalent(keyToValue, { pregnant: true }) ||
      this.isEquivalent(keyToValue, { infant: true })
    ) {
  ...
  screens = [
    <LetsGetStarted
      ...
      getNextScreen={this.getNextScreen}
      getLocalizedText={this.props.getLocalizedText}
    />,
    <SignUpYesorNo
      setUserInfo={this.setUserInfo}
      question={this.props.getLocalizedText("liveMiami")}
      value={"liveMiami"}
      getNextScreen={this.getNextScreen}
      getLocalizedText={this.props.getLocalizedText}
    />,
    ...
    <SignUpYesorNo
      setUserInfo={this.setUserInfo}
      question={this.props.getLocalizedText("areYouPregnant")}
      value={"pregnant"}
      getNextScreen={this.getNextScreen}
      getLocalizedText={this.props.getLocalizedText}
    />,
    <SignUpYesorNo
      setUserInfo={this.setUserInfo}
      question={this.props.getLocalizedText("doYouHaveInfants")}
      value={"infant"}
      getNextScreen={this.getNextScreen}
      getLocalizedText={this.props.getLocalizedText}
    />,
    ...
    />,
    <SignUpLoading
      signUpAndUploadData={this.signUpAndUploadData}
      getLocalizedText={this.props.getLocalizedText}
    />,
  ];
