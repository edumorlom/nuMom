  ...
  AsyncAlert = () => {
    return new Promise((resolve, reject) => {
      Alert.alert(
        ...
        [
          {
            text: this.props.getLocalizedText("Yes"),
            onPress: () => resolve(true),
          },
          {
            text: this.props.getLocalizedText("No"),
      ...
      <View style={{ flex: 1 }}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View>
            ...
            >
              {this.props.getLocalizedText("welcomeSetting")}
            </Text>
          </View>
          <View style={{ alignItems: "center", paddingTop: 25 }}>
            <View style={{ marginBottom: 30, alignItems: "center" }}>
              <Text style={appStyles.blueColor}>
                {this.props.getLocalizedText("phoneNumberInput")}:
              </Text>
            ...
            <View style={{ marginBottom: 30, alignItems: "center" }}>
              <Text style={appStyles.blueColor}>
                {this.props.getLocalizedText("dob")}:
              </Text>
              <View>
                <TextInputMask
                  type={"datetime"}
            ...
            <View style={{ marginBottom: 30, alignItems: "center" }}>
              <Text style={appStyles.blueColor}>
                {this.props.getLocalizedText("fullName")}:
              </Text>
              <View style={appStyles.TextInput.View}>
                <TextBox
            ...
            <View style={styles.containerDropDown}>
              ...
              >
                <Picker.Item
                  label={this.props.getLocalizedText("Yes")}
                  value={true}
                />
                <Picker.Item
                  label={this.props.getLocalizedText("No")}
                  value={false}
                />
              </Picker>
            </View>
                ...
                <Picker
                  ...
                  onValueChange={(itemValue, itemIndex) => {
                    return this.setState({
                      babyGender: { male: itemValue, female: itemValue },
                    });
                  }}
                >
                  <Picker.Item
                    label={this.props.getLocalizedText("Male")}
                    value={true}
                    key="1"
                  />
                  <Picker.Item
                    label={this.props.getLocalizedText("Female")}
                    value={false}
                    key="2"
                  />
                </Picker>
            ...
            {infant === true ? (
              <View>
                <Text style={{ alignSelf: "center" }}>
                  {this.props.getLocalizedText("babydob")} {babyDOB}
                </Text>
                <TextInputMask
                  type={"datetime"}
                  options={{
          ...
          >
            ...
            >
              <Text style={appStyles.button.text}>
                {this.props.getLocalizedText("save")}
              </Text>
            </TouchableHighlight>
          </View>
        </ScrollView>
